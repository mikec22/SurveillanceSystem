...
public class LineChartFragment extends Fragment {
    ...
    private GetResultDataTask mTask;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        vrVideoView = (VrVideoView) activity.findViewById(R.id.vrVideoView);
        videoView = (SimpleExoPlayerView) activity.findViewById(R.id.videoView);
        reportRecord = ((VideoLineChartReportActivity) activity).getReportRecord();
        player = ((VideoLineChartReportActivity) activity).getPlayer();
        ...
        lineChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                if (reportRecord.getType().equals("general"))
                    ...
                    vrVideoView.seekTo((long) (vrVideoView.getDuration() * percentage));
            }
...
//        });
    ...
    private void setLineChartData(LineChart lineChartData) {
